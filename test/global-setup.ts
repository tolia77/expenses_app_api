...
export default async function globalSetup(): Promise<void> {
  ...
  // Anything below here runs after the container is up. If it throws, Jest
  // won't invoke globalTeardown, so we stop the container ourselves to avoid
  // leaking Docker resources across test runs.
  try {
